      ...
      <div className="container max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {galleryImages.map((img, i) => (
            <motion.div
              key={i}
              className={`glass-card overflow-hidden cursor-pointer group ${i === 0 || i === 5 ? 'row-span-2' : ''}`}
            ...
            >
              <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-accent/30 to-muted/30 p-4">
        ...
        {selected !== null && (
          ...
          >
            ...
            >
              ...
              <h3 className="font-heading text-2xl text-gold mb-2">{galleryImages[selected].label}</h3>
